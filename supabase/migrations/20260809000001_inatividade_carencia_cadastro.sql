-- ══════════════════════════════════════════════════════════════════════
-- Migration 20260809000001 — Corrige falso-positivo de "aluno inativo":
--   aluno recém-cadastrado (sem historico_carga ainda) não pode ser
--   marcado como inativo antes de completar 7 dias de cadastro.
-- ══════════════════════════════════════════════════════════════════════
