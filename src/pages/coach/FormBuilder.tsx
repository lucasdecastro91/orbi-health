...
const FormBuilder = () => {
  ...
  const renderCampoEditor = (
    ...
    <div
      ...
      style={{ borderColor: "var(--section-card-border)", backgroundColor: "var(--section-card-bg-2)", boxShadow: "var(--section-card-shadow-2)" }}
    >
      {/* Header do campo */}
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
      ...
      <div
        ...
        style={{ borderColor: "var(--section-card-border)", backgroundColor: "var(--section-card-bg)", boxShadow: "var(--section-card-shadow)" }}
      >
        <div>
