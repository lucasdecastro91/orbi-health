...
const PlanModal = ({ orgId, trainerId, plan, onClose, onSaved }: PlanModalProps) => {
  ...
  const addOption = () => {
    ...
    const clientVal   = parseFloat(newClientValue.replace(",", "."));
  ...
  const handleSave = async () => {
    ...
    const pix = pixValue ? parseFloat(pixValue.replace(",", ".")) : null;
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex items-center justify-between px-4 pt-5 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Meus Planos</h1>
